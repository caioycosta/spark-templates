...
public abstract class TemplateViewRoute extends Route {
    ...
    public Object handle(Request request, Response response) {
	   ...
	   Object toRender = tempHandle(request,response);
       ModelAndView modelAndView = (ModelAndView)toRender;
	   return render(modelAndView);
    }
	
	public abstract Object tempHandle(Request request, Response response);
